 ...
 * Same token system as Navbar / ProductsPage:
...
const recentOrders: Order[] = [
  { id: "GC-10482", date: "12 Aug 2026", items: 6, total: 845, status: "Delivered" },
  { id: "GC-10467", date: "8 Aug 2026", items: 3, total: 320, status: "Delivered" },
  { id: "GC-10451", date: "14 Aug 2026", items: 9, total: 1240, status: "On the way" },
];
...
const stats = [
  ...
  { label: "Wallet Balance", value: "৳350", icon: Wallet },
];
    ...
    <section className="min-h-screen bg-[#FBF8F2] py-10">
      <div className="max-w-6xl mx-auto px-4">
          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <p className="text-xl font-bold text-[#26302A]">{stat.value}</p>
                  <p className="text-xs text-[#26302A]/55">{stat.label}</p>
                </div>
              </div>
            );
          })}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-6">
          {/* Recent orders */}
          <div
            className="rounded-2xl border border-[#E7E1D3] bg-white overflow-hidden animate-[fadeUp_0.55s_cubic-bezier(0.16,1,0.3,1)_0.1s_both]"
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#E7E1D3]">
              <h2 className="font-semibold text-[#26302A]">Recent Orders</h2>
              <Link
                href="/orders"
              ...
              {recentOrders.map((order, i) => (
                <li
                  ...
                  className={`flex items-center justify-between px-5 py-4 transition-colors hover:bg-[#FBF8F2] ${
                    i !== recentOrders.length - 1 ? "border-b border-[#E7E1D3]" : ""
                  }`}
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-[#26302A]">{order.id}</p>
                      <p className="flex items-center gap-1 text-xs text-[#26302A]/50">
                        <Clock size={11} /> {order.date} · {order.items} items
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-2xl border border-[#E7E1D3] bg-white p-5 animate-[fadeUp_0.55s_cubic-bezier(0.16,1,0.3,1)_0.15s_both]">
              <h2 className="font-semibold text-[#26302A] mb-4">Account</h2>
              <dl className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <dt className="text-[#26302A]/50">Email</dt>
                  <dd className="text-[#26302A] font-medium truncate max-w-[60%] text-right">
                    {user.email}
                  </dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-[#26302A]/50">Member since</dt>
                  <dd className="text-[#26302A] font-medium">2025</dd>
                </div>
              </dl>
              <Link
            ...
            <div className="rounded-2xl border border-[#E7E1D3] bg-white p-5 animate-[fadeUp_0.55s_cubic-bezier(0.16,1,0.3,1)_0.2s_both]">
              <div className="flex items-center gap-2 mb-3">
                <MapPin size={16} className="text-[#1F4D3A]" />
                <h2 className="font-semibold text-[#26302A]">Delivery Address</h2>
              </div>
